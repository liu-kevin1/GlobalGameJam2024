...
func _init():
	...
	dialogueManager.addDialogue(Dialogue.new("Cheesecake_Consumption1", [
		...
		DialogueLine.new("Player", "My rules, cake."),
	...
	dialogueManager.addDialogue(Dialogue.new("Cheesecake_Consumption2", [
		DialogueSwitchSprite.new("Cheesecake", "HAPPY"),
		DialogueLine.new("Narrator", "Being the psychopathic creature I am, I start dismembering the cheesecake"),
		...
		DialogueLine.new("Narrator", "I bring the chunk of cheesecake closer to my mouth"),
		DialogueSwitchSprite.new("Cheesecake", "FLUSHED"),
		...
		DialogueLine.new("Narrator", "I take a huge chomp out of the cheesecake and the screaming starts. Funny how a character characterized by the trait timid can still be written as loud in the right circumstances."),
		DialogueLine.new("Narrator", "I continue munching on the cheesecake until there's not a speck left on the plate. Although..."),
		DialogueLine.new("Player", "...Strange, why do I still hear screaming?"),
		DialogueLine.new("Narrator", "I try to move my arms to cover my ears from the screaming but they remain frozen at my sides. Suddenly the screaming stops and I feel my mouth close."),
		...
		DialogueLine.new("Narrator", "I try to take back the control of my body but despite my efforts the cheesecake moves my body out of the restaurant back into society."),
		DialogueLine.new("Narrator", "...At least I was able to get a meal out of this."),
	...
	dialogueManager.addDialogue(Dialogue.new("Cheesecake_Consumption3", [
		DialogueSwitchSprite.new("Narrator"),
		DialogueLine.new("Narrator", "I swallow the cheesecake as its screams go down into my body."),
		DialogueLine.new("Player", "I try to stand up but collapse."),
		DialogueLine.new("Player", "I lose my breath."),
		DialogueLine.new("Player", ".........", DialogueLineModifiers.new(1, true, [], [
