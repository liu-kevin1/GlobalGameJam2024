...
func _init():
	...
	dialogueManager.addDialogue(Dialogue.new("Pizza_ConsumptionP1", [
		...
		DialogueLine.new("Narrator", "You slowly lift up the pizza with your hands"),
	...
	dialogueManager.addDialogue(Dialogue.new("Pizza_ConsumptionP12", [
		...
		DialogueLine.new("Narrator", "You begin to chomp on the Pizza as their cheese begins to extend off of them"),
	...
	dialogueManager.addDialogue(Dialogue.new("Pizza_ConsumptionP2", [
		...
		DialogueLine.new("Narrator", "The Pizza sauce splats on the plate as you devour the slice within seconds."),
		DialogueSwitchSprite.new("Pizza 1"),
	...
	dialogueManager.addDialogue(Dialogue.new("Pizza_ConsumptionP22", [
		...
		DialogueSwitchSprite.new("Pizza 1"),
		DialogueLine.new("Narrator", "The other pizza begins crying."),
		DialogueLine.new("Narrator", "You crunch on the harder crust of the Pizza, somehow eating it backwards"),
